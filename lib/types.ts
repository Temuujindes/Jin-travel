...
export interface ItineraryDay { day: number; title: string; distance?: string; meals: string[]; accommodation: string; activities: string[]; image: string; descriptions?: LocalizedText; localizedTitle?: LocalizedText }
